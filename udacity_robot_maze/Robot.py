...
class Robot(object):
    ...
    def update_parameter(self):
        ...
        if self.testing:
            ...
            self.epsilon = 0.85 * self.epsilon
    ...
    def choose_action(self):
        ...
        def is_random_exploration():
            ...
            # it with epsilon
            prob_action = random.uniform(0, 1)
            return prob_action < self.epsilon
    ...
    def update_Qtable(self, r, action, next_state):
        ...
        if self.learning:
            ...
            # to the given rules
            current_state_value = self.Qtable[self.state][action]
            self.Qtable[self.state][action] = (1 - self.alpha) * current_state_value + self.alpha * (r + max(self.Qtable[next_state].values()))
